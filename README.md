...
| **supertonic-kmp** | Kotlin Multiplatform library for Android & iOS — offline, 31 languages, no forced playback abstractions | [GitHub](https://github.com/nedmah/supertonic-kmp) |
